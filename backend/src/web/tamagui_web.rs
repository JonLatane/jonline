...
use super::{index_summary, spa_file_or_username_or_custom_tab, spa_web_path, RellmResponder, SpaApp};
...
#[rocket::get("/tamagui")]
pub async fn index(state: &State<RocketState>) -> CacheResponse<Result<RellmResponder, Status>> {
