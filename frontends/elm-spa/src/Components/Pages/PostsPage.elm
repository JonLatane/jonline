...
postCardView shared ( host, post ) =
    ...
    in
    Posts.postCard shared.now shared.browserTimeZone shared.basePath shared.accountsPanel.mainFrontendHost host maybeServer maybeAccount onMediaClicked False False starred onStarClicked displayPost
