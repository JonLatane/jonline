...
module Proto.Jonline.Jonline exposing (accessToken, configureServer, createAIModelProvider, createAccount, createEvent, createEventSyncSource, createFollow, createGroup, createGroupPost, createMembership, createNewEventInstances, createPost, createSyncDestination, defederateProfile, deleteAIModelProvider, deleteEvent, deleteEventAttendance, deleteEventInstanceSyncDestination, deleteEventSyncSource, deleteFollow, deleteGroup, deleteGroupPost, deleteMedia, deleteMembership, deletePost, deletePostSyncDestination, deleteRemovedEventInstances, deleteSyncDestination, deleteUser, federateProfile, generateMedia, getAIModelProviders, getCurrentUser, getEventAttendances, getEventSyncSources, getEvents, getGroupPosts, getGroups, getMedia, getMembers, getMessages, getPosts, getPushSubscriptionStatus, getServerConfiguration, getServiceVersion, getSyncDestinations, getUsers, grantAIModelProvider, login, markMessagesRead, registerPushSubscription, resetData, resetPassword, revokeAIModelProvider, sendMessage, starPost, syncEventInstance, syncPost, unregisterPushSubscription, unstarPost, updateAIModelProvider, updateEvent, updateEventDetails, updateEventInstances, updateEventSyncSource, updateFollow, updateGroup, updateGroupPost, updateMembership, updatePost, updateSyncDestination, updateUser, upsertEventAttendance)
...
@docs accessToken, configureServer, createAIModelProvider, createAccount, createEvent, createEventSyncSource, createFollow, createGroup

@docs createGroupPost, createMembership, createNewEventInstances, createPost, createSyncDestination, defederateProfile

@docs deleteAIModelProvider, deleteEvent, deleteEventAttendance, deleteEventInstanceSyncDestination, deleteEventSyncSource, deleteFollow

@docs deleteGroup, deleteGroupPost, deleteMedia, deleteMembership, deletePost, deletePostSyncDestination, deleteRemovedEventInstances

@docs deleteSyncDestination, deleteUser, federateProfile, generateMedia, getAIModelProviders, getCurrentUser, getEventAttendances

@docs getEventSyncSources, getEvents, getGroupPosts, getGroups, getMedia, getMembers, getMessages, getPosts, getPushSubscriptionStatus

@docs getServerConfiguration, getServiceVersion, getSyncDestinations, getUsers, grantAIModelProvider, login, markMessagesRead

@docs registerPushSubscription, resetData, resetPassword, revokeAIModelProvider, sendMessage, starPost, syncEventInstance, syncPost

@docs unregisterPushSubscription, unstarPost, updateAIModelProvider, updateEvent, updateEventDetails, updateEventInstances

@docs updateEventSyncSource, updateFollow, updateGroup, updateGroupPost, updateMembership, updatePost, updateSyncDestination, updateUser

@docs upsertEventAttendance
...
-}
generateMedia : Grpc.Internal.Rpc Proto.Jonline.GenerateMediaRequest Proto.Jonline.Media
generateMedia =
    Grpc.Internal.Rpc
        { service = "Jonline"
        , package = "jonline"
        , rpcName = "GenerateMedia"
        , encoder = Proto.Jonline.encodeGenerateMediaRequest
        , decoder = Proto.Jonline.decodeMedia
        }


{-| A template for a gRPC call to the method 'RevokeAIModelProvider' sending a `RevokeAIModelProviderRequest` to get back a `Empty`.

 Revokes another user's access to one of the current user's AIModelProviders. *Authenticated*, owner-only (no Admin override).


-}
revokeAIModelProvider : Grpc.Internal.Rpc Proto.Jonline.RevokeAIModelProviderRequest Proto.Google.Protobuf.Empty
revokeAIModelProvider =
    Grpc.Internal.Rpc
        { service = "Jonline"
        , package = "jonline"
        , rpcName = "RevokeAIModelProvider"
        , encoder = Proto.Jonline.encodeRevokeAIModelProviderRequest
        , decoder = Proto.Google.Protobuf.decodeEmpty
        }


{-| A template for a gRPC call to the method 'GrantAIModelProvider' sending a `GrantAIModelProviderRequest` to get back a `AIModelProviderGrant`.
...
-}
grantAIModelProvider : Grpc.Internal.Rpc Proto.Jonline.GrantAIModelProviderRequest Proto.Jonline.AIModelProviderGrant
grantAIModelProvider =
    Grpc.Internal.Rpc
        { service = "Jonline"
        , package = "jonline"
        , rpcName = "GrantAIModelProvider"
        , encoder = Proto.Jonline.encodeGrantAIModelProviderRequest
        , decoder = Proto.Jonline.decodeAIModelProviderGrant
        }


{-| A template for a gRPC call to the method 'DeleteAIModelProvider' sending a `DeleteAIModelProviderRequest` to get back a `Empty`.

 Deletes an AIModelProvider (and its AIModelProviderGrants). *Authenticated* (owner, or Admin).


-}
deleteAIModelProvider : Grpc.Internal.Rpc Proto.Jonline.DeleteAIModelProviderRequest Proto.Google.Protobuf.Empty
deleteAIModelProvider =
    Grpc.Internal.Rpc
        { service = "Jonline"
        , package = "jonline"
        , rpcName = "DeleteAIModelProvider"
        , encoder = Proto.Jonline.encodeDeleteAIModelProviderRequest
        , decoder = Proto.Google.Protobuf.decodeEmpty
        }


{-| A template for a gRPC call to the method 'UpdateAIModelProvider' sending a `AIModelProvider` to get back a `AIModelProvider`.

 Updates an AIModelProvider's name, provider, or credentials. *Authenticated* (owner, or Admin for any user's).


-}
updateAIModelProvider : Grpc.Internal.Rpc Proto.Jonline.AIModelProvider Proto.Jonline.AIModelProvider
updateAIModelProvider =
    Grpc.Internal.Rpc
        { service = "Jonline"
        , package = "jonline"
        , rpcName = "UpdateAIModelProvider"
        , encoder = Proto.Jonline.encodeAIModelProvider
        , decoder = Proto.Jonline.decodeAIModelProvider
        }


{-| A template for a gRPC call to the method 'CreateAIModelProvider' sending a `AIModelProvider` to get back a `AIModelProvider`.

 Creates an AIModelProvider for the current user. *Authenticated*, requires `CREATE_AI_MODEL_PROVIDERS` (or Admin).


-}
createAIModelProvider : Grpc.Internal.Rpc Proto.Jonline.AIModelProvider Proto.Jonline.AIModelProvider
createAIModelProvider =
    Grpc.Internal.Rpc
        { service = "Jonline"
        , package = "jonline"
        , rpcName = "CreateAIModelProvider"
        , encoder = Proto.Jonline.encodeAIModelProvider
        , decoder = Proto.Jonline.decodeAIModelProvider
        }


{-| A template for a gRPC call to the method 'GetAIModelProviders' sending a `User` to get back a `GetAIModelProvidersResponse`.

 Gets a user's AIModelProviders. *Authenticated* (self, or Admin for any user).


-}
getAIModelProviders : Grpc.Internal.Rpc Proto.Jonline.User Proto.Jonline.GetAIModelProvidersResponse
getAIModelProviders =
    Grpc.Internal.Rpc
        { service = "Jonline"
        , package = "jonline"
        , rpcName = "GetAIModelProviders"
        , encoder = Proto.Jonline.encodeUser
        , decoder = Proto.Jonline.decodeGetAIModelProvidersResponse
        }
...
-}
deleteSyncDestination : Grpc.Internal.Rpc Proto.Jonline.DeleteSyncDestinationRequest Proto.Google.Protobuf.Empty
deleteSyncDestination =
    Grpc.Internal.Rpc
        { service = "Jonline"
        , package = "jonline"
        , rpcName = "DeleteSyncDestination"
        , encoder = Proto.Jonline.encodeDeleteSyncDestinationRequest
        , decoder = Proto.Google.Protobuf.decodeEmpty
        }
...
-}
updateSyncDestination : Grpc.Internal.Rpc Proto.Jonline.SyncDestination Proto.Jonline.SyncDestination
updateSyncDestination =
    Grpc.Internal.Rpc
        { service = "Jonline"
        , package = "jonline"
        , rpcName = "UpdateSyncDestination"
        , encoder = Proto.Jonline.encodeSyncDestination
        , decoder = Proto.Jonline.decodeSyncDestination
        }
...
-}
createSyncDestination : Grpc.Internal.Rpc Proto.Jonline.SyncDestination Proto.Jonline.SyncDestination
...
-}
getSyncDestinations : Grpc.Internal.Rpc Proto.Jonline.User Proto.Jonline.GetSyncDestinationsResponse
getSyncDestinations =
    Grpc.Internal.Rpc
        { service = "Jonline"
        , package = "jonline"
        ...
        , encoder = Proto.Jonline.encodeUser
        , decoder = Proto.Jonline.decodeGetSyncDestinationsResponse
        }
...
{-| A template for a gRPC call to the method 'DeleteRemovedEventInstances' sending a `Event` to get back a `Event`.

 Deletes EventInstances in an existing Event that aren't present in the input Event. *Authenticated.*


-}
deleteRemovedEventInstances : Grpc.Internal.Rpc Proto.Jonline.Event Proto.Jonline.Event
deleteRemovedEventInstances =
    Grpc.Internal.Rpc
        { service = "Jonline"
        , package = "jonline"
        , rpcName = "DeleteRemovedEventInstances"
        , encoder = Proto.Jonline.encodeEvent
        , decoder = Proto.Jonline.decodeEvent
        }


{-| A template for a gRPC call to the method 'UpdateEventInstances' sending a `Event` to get back a `Event`.
...
-}
updateEventInstances : Grpc.Internal.Rpc Proto.Jonline.Event Proto.Jonline.Event
updateEventInstances =
    Grpc.Internal.Rpc
        { service = "Jonline"
        , package = "jonline"
        , rpcName = "UpdateEventInstances"
        , encoder = Proto.Jonline.encodeEvent
        , decoder = Proto.Jonline.decodeEvent
        }


{-| A template for a gRPC call to the method 'CreateNewEventInstances' sending a `Event` to get back a `Event`.
...
-}
createNewEventInstances : Grpc.Internal.Rpc Proto.Jonline.Event Proto.Jonline.Event
createNewEventInstances =
    Grpc.Internal.Rpc
        { service = "Jonline"
        , package = "jonline"
        , rpcName = "CreateNewEventInstances"
        , encoder = Proto.Jonline.encodeEvent
        , decoder = Proto.Jonline.decodeEvent
        }
...
-}
updateEventDetails : Grpc.Internal.Rpc Proto.Jonline.Event Proto.Jonline.Event
updateEventDetails =
    Grpc.Internal.Rpc
        { service = "Jonline"
        , package = "jonline"
...
-}
deletePostSyncDestination : Grpc.Internal.Rpc Proto.Jonline.DeletePostSyncDestinationRequest Proto.Google.Protobuf.Empty
deletePostSyncDestination =
    Grpc.Internal.Rpc
        { service = "Jonline"
        , package = "jonline"
        , rpcName = "DeletePostSyncDestination"
        , encoder = Proto.Jonline.encodeDeletePostSyncDestinationRequest
        , decoder = Proto.Google.Protobuf.decodeEmpty
        }
...
-}
syncPost : Grpc.Internal.Rpc Proto.Jonline.SyncPostRequest Proto.Jonline.Post
syncPost =
    Grpc.Internal.Rpc
        { service = "Jonline"
        , package = "jonline"
        , rpcName = "SyncPost"
        , encoder = Proto.Jonline.encodeSyncPostRequest
...
getPushSubscriptionStatus :
    Grpc.Internal.Rpc Proto.Jonline.GetPushSubscriptionStatusRequest Proto.Jonline.GetPushSubscriptionStatusResponse
getPushSubscriptionStatus =
    Grpc.Internal.Rpc
        { service = "Jonline"
        , package = "jonline"
        , rpcName = "GetPushSubscriptionStatus"
        , encoder = Proto.Jonline.encodeGetPushSubscriptionStatusRequest
        , decoder = Proto.Jonline.decodeGetPushSubscriptionStatusResponse
        }
...
unregisterPushSubscription :
    Grpc.Internal.Rpc Proto.Jonline.UnregisterPushSubscriptionRequest Proto.Google.Protobuf.Empty
unregisterPushSubscription =
    Grpc.Internal.Rpc
        { service = "Jonline"
        , package = "jonline"
        , rpcName = "UnregisterPushSubscription"
        , encoder = Proto.Jonline.encodeUnregisterPushSubscriptionRequest
        , decoder = Proto.Google.Protobuf.decodeEmpty
        }
...
registerPushSubscription :
    Grpc.Internal.Rpc Proto.Jonline.RegisterPushSubscriptionRequest Proto.Jonline.PushSubscription
registerPushSubscription =
    Grpc.Internal.Rpc
        { service = "Jonline"
        , package = "jonline"
        , rpcName = "RegisterPushSubscription"
        , encoder = Proto.Jonline.encodeRegisterPushSubscriptionRequest
        , decoder = Proto.Jonline.decodePushSubscription
        }
