...
@docs getServiceVersion, getUsers, login, resetData, resetPassword, sendMessage, starPost, syncEventInstance, unstarPost, updateEvent

@docs updateEventSyncDestination, updateEventSyncSource, updateFollow, updateGroup, updateGroupPost, updateMembership, updatePost

@docs updateUser, upsertEventAttendance
