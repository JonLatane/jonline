...
module Proto.Jonline.Jonline exposing (accessToken, configureServer, createAIModelProvider, createAccount, createEvent, createFollow, createGroup, createGroupPost, createMembership, createNewEventInstances, createPost, createSyncDestination, createSyncSource, defederateProfile, deleteAIModelProvider, deleteEvent, deleteEventAttendance, deleteEventInstanceSyncDestination, deleteFollow, deleteGroup, deleteGroupPost, deleteMedia, deleteMembership, deletePost, deletePostSyncDestination, deleteRemovedEventInstances, deleteSyncDestination, deleteSyncSource, deleteUser, federateProfile, generateMedia, getAIModelProviders, getCurrentUser, getEventAttendances, getEvents, getGroupPosts, getGroups, getMedia, getMembers, getMessages, getPosts, getPushSubscriptionStatus, getServerConfiguration, getServiceVersion, getSyncDestinations, getSyncSources, getUsers, grantAIModelProvider, login, markMessagesRead, registerPushSubscription, resetData, resetPassword, revokeAIModelProvider, sendMessage, starPost, syncEventInstance, syncPost, unregisterPushSubscription, unstarPost, updateAIModelProvider, updateEvent, updateEventDetails, updateEventInstances, updateFollow, updateGroup, updateGroupPost, updateMembership, updatePost, updateSyncDestination, updateSyncSource, updateUser, upsertEventAttendance)
...
@docs accessToken, configureServer, createAIModelProvider, createAccount, createEvent, createFollow, createGroup, createGroupPost

@docs createMembership, createNewEventInstances, createPost, createSyncDestination, createSyncSource, defederateProfile

@docs deleteAIModelProvider, deleteEvent, deleteEventAttendance, deleteEventInstanceSyncDestination, deleteFollow, deleteGroup

@docs deleteGroupPost, deleteMedia, deleteMembership, deletePost, deletePostSyncDestination, deleteRemovedEventInstances

@docs deleteSyncDestination, deleteSyncSource, deleteUser, federateProfile, generateMedia, getAIModelProviders, getCurrentUser
...
@docs getServerConfiguration, getServiceVersion, getSyncDestinations, getSyncSources, getUsers, grantAIModelProvider, login

@docs markMessagesRead, registerPushSubscription, resetData, resetPassword, revokeAIModelProvider, sendMessage, starPost, syncEventInstance

@docs syncPost, unregisterPushSubscription, unstarPost, updateAIModelProvider, updateEvent, updateEventDetails, updateEventInstances

@docs updateFollow, updateGroup, updateGroupPost, updateMembership, updatePost, updateSyncDestination, updateSyncSource, updateUser
...
-}
deleteSyncSource : Grpc.Internal.Rpc Proto.Jonline.DeleteSyncSourceRequest Proto.Google.Protobuf.Empty
deleteSyncSource =
    Grpc.Internal.Rpc
        { service = "Jonline"
        , package = "jonline"
        , rpcName = "DeleteSyncSource"
        , encoder = Proto.Jonline.encodeDeleteSyncSourceRequest
        , decoder = Proto.Google.Protobuf.decodeEmpty
        }
...
-}
updateSyncSource : Grpc.Internal.Rpc Proto.Jonline.SyncSource Proto.Jonline.SyncSource
updateSyncSource =
    Grpc.Internal.Rpc
        { service = "Jonline"
        , package = "jonline"
        , rpcName = "UpdateSyncSource"
        , encoder = Proto.Jonline.encodeSyncSource
        , decoder = Proto.Jonline.decodeSyncSource
        }
...
-}
createSyncSource : Grpc.Internal.Rpc Proto.Jonline.SyncSource Proto.Jonline.SyncSource
createSyncSource =
    Grpc.Internal.Rpc
        { service = "Jonline"
        , package = "jonline"
...
-}
getSyncSources : Grpc.Internal.Rpc Proto.Jonline.User Proto.Jonline.GetSyncSourcesResponse
getSyncSources =
    Grpc.Internal.Rpc
        { service = "Jonline"
        , package = "jonline"
        ...
        , encoder = Proto.Jonline.encodeUser
        , decoder = Proto.Jonline.decodeGetSyncSourcesResponse
        }
