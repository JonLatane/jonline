...
@docs deleteSyncDestination, deleteUser, federateProfile, getAIModelProviders, getCurrentUser, getEventAttendances, getEventSyncSources

@docs getEvents, getGroupPosts, getGroups, getMedia, getMembers, getMessages, getPosts, getPushSubscriptionStatus, getServerConfiguration

@docs getServiceVersion, getSyncDestinations, getUsers, grantAIModelProvider, login, markMessagesRead, registerPushSubscription, resetData

@docs resetPassword, revokeAIModelProvider, sendMessage, starPost, syncEventInstance, syncPost, unregisterPushSubscription, unstarPost

@docs updateAIModelProvider, updateEvent, updateEventDetails, updateEventInstances, updateEventSyncSource, updateFollow, updateGroup

@docs updateGroupPost, updateMembership, updatePost, updateSyncDestination, updateUser, upsertEventAttendance
