...
@docs getServiceVersion, getUsers, login, markMessagesRead, registerPushSubscription, resetData, resetPassword, sendMessage, starPost

@docs syncEventInstance, unregisterPushSubscription, unstarPost, updateEvent, updateEventSyncDestination, updateEventSyncSource
