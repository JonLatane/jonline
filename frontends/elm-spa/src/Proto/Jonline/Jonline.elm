...
@docs getServerConfiguration, getServiceVersion, getUsers, login, markMessagesRead, registerPushSubscription, resetData, resetPassword

@docs sendMessage, starPost, syncEventInstance, unregisterPushSubscription, unstarPost, updateEvent, updateEventSyncDestination

@docs updateEventSyncSource, updateFollow, updateGroup, updateGroupPost, updateMembership, updatePost, updateUser, upsertEventAttendance
