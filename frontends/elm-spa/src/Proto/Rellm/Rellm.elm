...
@docs revokeAIModelProvider, sendMessage, starPost, syncEventInstance, syncPost, unregisterPushSubscription, unstarPost

@docs updateAIModelProvider, updateEvent, updateEventDetails, updateEventInstances, updateFollow, updateGroup, updateGroupPost

@docs updateMembership, updatePost, updateSyncDestination, updateSyncSource, updateUser, upsertEventAttendance
