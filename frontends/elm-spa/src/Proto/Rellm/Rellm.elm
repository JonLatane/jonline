...
module Proto.Rellm.Rellm exposing (accessToken, configureServer, createAIModelProvider, createAccount, createEvent, createFollow, createGroup, createGroupPost, createMembership, createNewEventInstances, createPost, createSyncDestination, createSyncSource, defederateProfile, deleteAIModelProvider, deleteEvent, deleteEventAttendance, deleteEventInstanceSyncDestination, deleteFollow, deleteGroup, deleteGroupPost, deleteMedia, deleteMembership, deletePost, deletePostSyncDestination, deleteRemovedEventInstances, deleteSyncDestination, deleteSyncSource, deleteUser, federateProfile, freeClusterResources, generateMedia, getAIModelProviders, getCurrentUser, getEventAttendances, getEvents, getGroupPosts, getGroups, getMedia, getMembers, getMessages, getPosts, getPushSubscriptionStatus, getServerConfiguration, getServiceVersion, getSyncDestinations, getSyncSources, getUsers, grantAIModelProvider, lockClusterResources, login, markMessagesRead, registerPushSubscription, resetData, resetPassword, revokeAIModelProvider, sendMessage, starPost, startContactMethodVerification, syncEventInstance, syncPost, unregisterPushSubscription, unstarPost, updateAIModelProvider, updateEvent, updateEventDetails, updateEventInstances, updateFollow, updateGroup, updateGroupPost, updateMembership, updatePost, updateSyncDestination, updateSyncSource, updateUser, upsertEventAttendance, verifyContactMethod)
...
@docs deleteSyncDestination, deleteSyncSource, deleteUser, federateProfile, freeClusterResources, generateMedia, getAIModelProviders

@docs getCurrentUser, getEventAttendances, getEvents, getGroupPosts, getGroups, getMedia, getMembers, getMessages, getPosts

@docs getPushSubscriptionStatus, getServerConfiguration, getServiceVersion, getSyncDestinations, getSyncSources, getUsers

@docs grantAIModelProvider, lockClusterResources, login, markMessagesRead, registerPushSubscription, resetData, resetPassword

@docs revokeAIModelProvider, sendMessage, starPost, startContactMethodVerification, syncEventInstance, syncPost

@docs unregisterPushSubscription, unstarPost, updateAIModelProvider, updateEvent, updateEventDetails, updateEventInstances, updateFollow

@docs updateGroup, updateGroupPost, updateMembership, updatePost, updateSyncDestination, updateSyncSource, updateUser, upsertEventAttendance

@docs verifyContactMethod
...
-}
revokeAIModelProvider : Grpc.Internal.Rpc Proto.Rellm.RevokeAIModelProviderRequest Proto.Google.Protobuf.Empty
revokeAIModelProvider =
    Grpc.Internal.Rpc
        { service = "Rellm"
        , package = "rellm"
        , rpcName = "RevokeAIModelProvider"
        , encoder = Proto.Rellm.encodeRevokeAIModelProviderRequest
        , decoder = Proto.Google.Protobuf.decodeEmpty
        }
...
-}
grantAIModelProvider : Grpc.Internal.Rpc Proto.Rellm.GrantAIModelProviderRequest Proto.Rellm.AIModelProviderGrant
grantAIModelProvider =
    Grpc.Internal.Rpc
        { service = "Rellm"
        , package = "rellm"
        , rpcName = "GrantAIModelProvider"
        , encoder = Proto.Rellm.encodeGrantAIModelProviderRequest
        , decoder = Proto.Rellm.decodeAIModelProviderGrant
        }
...
-}
deleteAIModelProvider : Grpc.Internal.Rpc Proto.Rellm.DeleteAIModelProviderRequest Proto.Google.Protobuf.Empty
deleteAIModelProvider =
    Grpc.Internal.Rpc
        { service = "Rellm"
        , package = "rellm"
        , rpcName = "DeleteAIModelProvider"
        , encoder = Proto.Rellm.encodeDeleteAIModelProviderRequest
        , decoder = Proto.Google.Protobuf.decodeEmpty
        }
...
-}
updateAIModelProvider : Grpc.Internal.Rpc Proto.Rellm.AIModelProvider Proto.Rellm.AIModelProvider
updateAIModelProvider =
    Grpc.Internal.Rpc
        { service = "Rellm"
        , package = "rellm"
        , rpcName = "UpdateAIModelProvider"
        , encoder = Proto.Rellm.encodeAIModelProvider
        , decoder = Proto.Rellm.decodeAIModelProvider
        }
...
-}
createAIModelProvider : Grpc.Internal.Rpc Proto.Rellm.AIModelProvider Proto.Rellm.AIModelProvider
...
-}
getAIModelProviders : Grpc.Internal.Rpc Proto.Rellm.User Proto.Rellm.GetAIModelProvidersResponse
getAIModelProviders =
    Grpc.Internal.Rpc
        { service = "Rellm"
        , package = "rellm"
        ...
        , decoder = Proto.Rellm.decodeGetAIModelProvidersResponse
        }
...
deleteEventInstanceSyncDestination :
    Grpc.Internal.Rpc Proto.Rellm.DeleteEventInstanceSyncDestinationRequest Proto.Google.Protobuf.Empty
deleteEventInstanceSyncDestination =
    Grpc.Internal.Rpc
        { service = "Rellm"
        , package = "rellm"
        , rpcName = "DeleteEventInstanceSyncDestination"
        , encoder = Proto.Rellm.encodeDeleteEventInstanceSyncDestinationRequest
        , decoder = Proto.Google.Protobuf.decodeEmpty
        }
...
-}
syncEventInstance : Grpc.Internal.Rpc Proto.Rellm.SyncEventInstanceRequest Proto.Rellm.EventInstance
syncEventInstance =
    Grpc.Internal.Rpc
        { service = "Rellm"
        , package = "rellm"
        , rpcName = "SyncEventInstance"
        , encoder = Proto.Rellm.encodeSyncEventInstanceRequest
        , decoder = Proto.Rellm.decodeEventInstance
        }
...
-}
deleteRemovedEventInstances : Grpc.Internal.Rpc Proto.Rellm.Event Proto.Rellm.Event
deleteRemovedEventInstances =
    Grpc.Internal.Rpc
        { service = "Rellm"
        , package = "rellm"
...
-}
updateEventInstances : Grpc.Internal.Rpc Proto.Rellm.Event Proto.Rellm.Event
...
-}
createNewEventInstances : Grpc.Internal.Rpc Proto.Rellm.Event Proto.Rellm.Event
