...
@docs deleteEventAttendance, deleteFollow, deleteGroup, deleteGroupPost, deleteMedia, deleteMembership, deleteOccasionSyncDestination

@docs deletePost, deletePostSyncDestination, deleteRemovedOccasions, deleteSyncDestination, deleteSyncSource, deleteUser, federateProfile

@docs freeClusterResources, generateMedia, getAIProviders, getCurrentUser, getEventAttendances, getEvents, getGroupPosts, getGroups, getMedia
...
@docs getSyncSources, getUsers, grantAIProvider, lockClusterResources, login, markMessagesRead, registerPushSubscription, resetData

@docs resetPassword, revokeAIProvider, sendMessage, starPost, startContactMethodVerification, syncOccasion, syncPost
...
@docs updateMembership, updateOccasions, updatePost, updateSyncDestination, updateSyncSource, updateUser, upsertEventAttendance
