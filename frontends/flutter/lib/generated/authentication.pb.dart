...
class CreateAccountRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CreateAccountRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'jonline'), createEmptyInstance: create)
    ...
    ..aOM<$10.Timestamp>(5, _omitFieldNames ? '' : 'expiresAt', subBuilder: $10.Timestamp.create)
  ...
  @$pb.TagNumber(5)
  $10.Timestamp get expiresAt => $_getN(4);
  @$pb.TagNumber(5)
  set expiresAt($10.Timestamp v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasExpiresAt() => $_has(4);
  @$pb.TagNumber(5)
  void clearExpiresAt() => clearField(5);
  @$pb.TagNumber(5)
  $10.Timestamp ensureExpiresAt() => $_ensure(4);
...
class LoginRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LoginRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'jonline'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'username')
    ..aOS(2, _omitFieldNames ? '' : 'password')
    ..aOM<$10.Timestamp>(3, _omitFieldNames ? '' : 'expiresAt', subBuilder: $10.Timestamp.create)
  ...
  /// Request an expiration time for the Auth Token returned. By default it will not expire.
  @$pb.TagNumber(3)
  $10.Timestamp get expiresAt => $_getN(2);
  @$pb.TagNumber(3)
  set expiresAt($10.Timestamp v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasExpiresAt() => $_has(2);
  @$pb.TagNumber(3)
  void clearExpiresAt() => clearField(3);
  @$pb.TagNumber(3)
  $10.Timestamp ensureExpiresAt() => $_ensure(2);
...
class CreateThirdPartyRefreshTokenRequest extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(2)
  $10.Timestamp get expiresAt => $_getN(0);
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(2)
  $10.Timestamp ensureExpiresAt() => $_ensure(0);
