...
const Conversation$json = const {
  ...
  '2': const [
    ...
    const {'1': 'user_ids', '3': 3, '4': 3, '5': 9, '10': 'userIds'},
  ],
  '8': const [
    const {'1': '_name'},
  ],
...
final $typed_data.Uint8List conversationDescriptor = $convert.base64Decode('CgxDb252ZXJzYXRpb24SDgoCaWQYASABKAlSAmlkEhcKBG5hbWUYAiABKAlIAFIEbmFtZYgBARIZCgh1c2VyX2lkcxgDIAMoCVIHdXNlcklkc0IHCgVfbmFtZQ==');
@$core.Deprecated('Use conversationPostDescriptor instead')
const ConversationPost$json = const {
  '1': 'ConversationPost',
  '2': const [
...
final $typed_data.Uint8List conversationPostDescriptor = $convert.base64Decode('ChBDb252ZXJzYXRpb25Qb3N0EicKD2NvbnZlcnNhdGlvbl9pZBgBIAEoCVIOY29udmVyc2F0aW9uSWQSFwoHcG9zdF9pZBgCIAEoCVIGcG9zdElk');
...
final $typed_data.Uint8List groupConversationDescriptor = $convert.base64Decode('ChFHcm91cENvbnZlcnNhdGlvbhIZCghncm91cF9pZBgBIAEoCVIHZ3JvdXBJZA==');
@$core.Deprecated('Use groupConversationPostDescriptor instead')
const GroupConversationPost$json = const {
...
final $typed_data.Uint8List groupConversationPostDescriptor = $convert.base64Decode('ChVHcm91cENvbnZlcnNhdGlvblBvc3QSGQoIZ3JvdXBfaWQYASABKAlSB2dyb3VwSWQSFwoHcG9zdF9pZBgCIAEoCVIGcG9zdElk');
@$core.Deprecated('Use createConversationPostRequestDescriptor instead')
const CreateConversationPostRequest$json = const {
...
const GetConversationsRequest$json = const {
  ...
  '2': const [
    const {'1': 'page', '3': 10, '4': 1, '5': 13, '10': 'page'},
  ],
};

/// Descriptor for `GetConversationsRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getConversationsRequestDescriptor = $convert.base64Decode('ChdHZXRDb252ZXJzYXRpb25zUmVxdWVzdBISCgRwYWdlGAogASgNUgRwYWdl');
...
const GetConversationsResponse$json = const {
  ...
  '2': const [
    const {'1': 'conversations', '3': 1, '4': 3, '5': 11, '6': '.jonline.Conversation', '10': 'conversations'},
  ],
};

/// Descriptor for `GetConversationsResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getConversationsResponseDescriptor = $convert.base64Decode('ChhHZXRDb252ZXJzYXRpb25zUmVzcG9uc2USOwoNY29udmVyc2F0aW9ucxgBIAMoCzIVLmpvbmxpbmUuQ29udmVyc2F0aW9uUg1jb252ZXJzYXRpb25z');
...
const GetConversationRequest$json = const {
  ...
  '2': const [
    const {'1': 'conversation_id', '3': 1, '4': 1, '5': 9, '9': 0, '10': 'conversationId'},
    const {'1': 'group_id', '3': 2, '4': 1, '5': 9, '9': 0, '10': 'groupId'},
    const {'1': 'page', '3': 10, '4': 1, '5': 13, '10': 'page'},
  ],
  '8': const [
    const {'1': 'requested_id'},
  ],
};

/// Descriptor for `GetConversationRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getConversationRequestDescriptor = $convert.base64Decode('ChZHZXRDb252ZXJzYXRpb25SZXF1ZXN0EikKD2NvbnZlcnNhdGlvbl9pZBgBIAEoCUgAUg5jb252ZXJzYXRpb25JZBIbCghncm91cF9pZBgCIAEoCUgAUgdncm91cElkEhIKBHBhZ2UYCiABKA1SBHBhZ2VCDgoMcmVxdWVzdGVkX2lk');
...
const GetConversationResponse$json = const {
  ...
  '2': const [
    const {'1': 'conversation', '3': 1, '4': 3, '5': 11, '6': '.jonline.Post', '10': 'conversation'},
  ],
};

/// Descriptor for `GetConversationResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getConversationResponseDescriptor = $convert.base64Decode('ChdHZXRDb252ZXJzYXRpb25SZXNwb25zZRIxCgxjb252ZXJzYXRpb24YASADKAsyDS5qb25saW5lLlBvc3RSDGNvbnZlcnNhdGlvbg==');
