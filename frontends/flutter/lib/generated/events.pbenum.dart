...
class EventListingType extends $pb.ProtobufEnum {
  ...
  static const EventListingType ALL_ACCESSIBLE_EVENTS =
      EventListingType._(0, _omitEnumNames ? '' : 'ALL_ACCESSIBLE_EVENTS');

  /// Returns events from users the user is following.
  static const EventListingType FOLLOWING_EVENTS =
      EventListingType._(1, _omitEnumNames ? '' : 'FOLLOWING_EVENTS');

  /// Returns events from any group the user is a member of.
  static const EventListingType MY_GROUPS_EVENTS =
      EventListingType._(2, _omitEnumNames ? '' : 'MY_GROUPS_EVENTS');

  /// Returns `DIRECT` events that are directly addressed to the user.
  static const EventListingType DIRECT_EVENTS =
      EventListingType._(3, _omitEnumNames ? '' : 'DIRECT_EVENTS');
  ...
  static const EventListingType GROUP_EVENTS_PENDING_MODERATION =
      EventListingType._(
          11, _omitEnumNames ? '' : 'GROUP_EVENTS_PENDING_MODERATION');
  ...
  static const EventListingType NEWLY_ADDED_EVENTS =
      EventListingType._(20, _omitEnumNames ? '' : 'NEWLY_ADDED_EVENTS');
  ...
  static final $core.Map<$core.int, EventListingType> _byValue =
...
class AttendanceStatus extends $pb.ProtobufEnum {
  ...
  static const AttendanceStatus INTERESTED =
      AttendanceStatus._(0, _omitEnumNames ? '' : 'INTERESTED');

  /// Another user has invited the user to the event.
  static const AttendanceStatus REQUESTED =
      AttendanceStatus._(1, _omitEnumNames ? '' : 'REQUESTED');

  /// The user plans to go to the event, or went to the event.
  static const AttendanceStatus GOING =
      AttendanceStatus._(2, _omitEnumNames ? '' : 'GOING');

  /// The user does not plan to go to the event, or did not go to the event.
  static const AttendanceStatus NOT_GOING =
      AttendanceStatus._(3, _omitEnumNames ? '' : 'NOT_GOING');
