...
const Group$json = const {
  ...
  '2': const [
    ...
    const {'1': 'avatar', '3': 4, '4': 1, '5': 12, '9': 0, '10': 'avatar', '17': true},
    const {'1': 'default_membership_permissions', '3': 5, '4': 3, '5': 14, '6': '.jonline.Permission', '10': 'defaultMembershipPermissions'},
    const {'1': 'default_membership_moderation', '3': 6, '4': 1, '5': 14, '6': '.jonline.Moderation', '10': 'defaultMembershipModeration'},
    const {'1': 'default_post_moderation', '3': 7, '4': 1, '5': 14, '6': '.jonline.Moderation', '10': 'defaultPostModeration'},
    const {'1': 'default_event_moderation', '3': 8, '4': 1, '5': 14, '6': '.jonline.Moderation', '10': 'defaultEventModeration'},
    const {'1': 'visibility', '3': 9, '4': 1, '5': 14, '6': '.jonline.Visibility', '10': 'visibility'},
    const {'1': 'member_count', '3': 10, '4': 1, '5': 13, '10': 'memberCount'},
    const {'1': 'post_count', '3': 11, '4': 1, '5': 13, '10': 'postCount'},
    const {'1': 'current_user_membership', '3': 12, '4': 1, '5': 11, '6': '.jonline.Membership', '9': 1, '10': 'currentUserMembership', '17': true},
    const {'1': 'created_at', '3': 13, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '10': 'createdAt'},
    const {'1': 'updated_at', '3': 14, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '9': 2, '10': 'updatedAt', '17': true},
  ],
  '8': const [
    const {'1': '_avatar'},
...
final $typed_data.Uint8List groupDescriptor = $convert.base64Decode('');
...
const GetGroupsRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'listing_type', '3': 3, '4': 1, '5': 14, '6': '.jonline.GroupListingType', '10': 'listingType'},
    const {'1': 'page', '3': 4, '4': 1, '5': 5, '9': 2, '10': 'page', '17': true},
  ],
  '8': const [
    const {'1': '_group_id'},
    const {'1': '_group_name'},
...
final $typed_data.Uint8List getGroupsRequestDescriptor = $convert.base64Decode('');
