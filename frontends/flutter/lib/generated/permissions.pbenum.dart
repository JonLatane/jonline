...
class Permission extends $pb.ProtobufEnum {
  ...
  static const Permission MODERATE_USERS =
      Permission._(4, _omitEnumNames ? '' : 'MODERATE_USERS');

  /// Allow the user to follow other users.
  static const Permission FOLLOW_USERS =
      Permission._(5, _omitEnumNames ? '' : 'FOLLOW_USERS');
  ...
  static const Permission GRANT_BASIC_PERMISSIONS =
      Permission._(6, _omitEnumNames ? '' : 'GRANT_BASIC_PERMISSIONS');
  ...
  static const Permission VIEW_GROUPS =
      Permission._(10, _omitEnumNames ? '' : 'VIEW_GROUPS');

  /// Allow the user to create groups.
  static const Permission CREATE_GROUPS =
      Permission._(11, _omitEnumNames ? '' : 'CREATE_GROUPS');

  /// Allow the user to give groups `SERVER_PUBLIC` visibility.
  static const Permission PUBLISH_GROUPS_LOCALLY =
      Permission._(12, _omitEnumNames ? '' : 'PUBLISH_GROUPS_LOCALLY');

  /// Allow the user to give groups `GLOBAL_PUBLIC` visibility.
  static const Permission PUBLISH_GROUPS_GLOBALLY =
      Permission._(13, _omitEnumNames ? '' : 'PUBLISH_GROUPS_GLOBALLY');

  /// The Moderate Groups permission makes a user effectively an admin of *any* group.
  static const Permission MODERATE_GROUPS =
      Permission._(14, _omitEnumNames ? '' : 'MODERATE_GROUPS');

  /// Allow the user to (potentially request to) join groups of `SERVER_PUBLIC` or higher
  /// visibility.
  static const Permission JOIN_GROUPS =
      Permission._(15, _omitEnumNames ? '' : 'JOIN_GROUPS');

  /// Allow the user to invite other users to groups. Only applicable as a Group permission (not at the User level).
  static const Permission INVITE_GROUP_MEMBERS =
      Permission._(16, _omitEnumNames ? '' : 'INVITE_GROUP_MEMBERS');
  ...
  static const Permission VIEW_POSTS =
      Permission._(20, _omitEnumNames ? '' : 'VIEW_POSTS');
  ...
  static const Permission CREATE_POSTS =
      Permission._(21, _omitEnumNames ? '' : 'CREATE_POSTS');

  /// Allow the user to publish posts with `SERVER_PUBLIC` visibility.
  static const Permission PUBLISH_POSTS_LOCALLY =
      Permission._(22, _omitEnumNames ? '' : 'PUBLISH_POSTS_LOCALLY');

  /// Allow the user to publish posts with `GLOBAL_PUBLIC` visibility.
  static const Permission PUBLISH_POSTS_GLOBALLY =
      Permission._(23, _omitEnumNames ? '' : 'PUBLISH_POSTS_GLOBALLY');

  /// Allow the user to moderate posts.
  static const Permission MODERATE_POSTS =
      Permission._(24, _omitEnumNames ? '' : 'MODERATE_POSTS');

  /// Allow the user to reply to posts.
  static const Permission REPLY_TO_POSTS =
      Permission._(25, _omitEnumNames ? '' : 'REPLY_TO_POSTS');
  ...
  static const Permission VIEW_EVENTS =
      Permission._(30, _omitEnumNames ? '' : 'VIEW_EVENTS');
  ...
  static const Permission CREATE_EVENTS =
      Permission._(31, _omitEnumNames ? '' : 'CREATE_EVENTS');

  /// Allow the user to publish events with `SERVER_PUBLIC` visibility.
  static const Permission PUBLISH_EVENTS_LOCALLY =
      Permission._(32, _omitEnumNames ? '' : 'PUBLISH_EVENTS_LOCALLY');

  /// Allow the user to publish events with `GLOBAL_PUBLIC` visibility.
  static const Permission PUBLISH_EVENTS_GLOBALLY =
      Permission._(33, _omitEnumNames ? '' : 'PUBLISH_EVENTS_GLOBALLY');

  /// Allow the user to moderate events.
  static const Permission MODERATE_EVENTS =
      Permission._(34, _omitEnumNames ? '' : 'MODERATE_EVENTS');
  ...
  static const Permission VIEW_MEDIA =
      Permission._(40, _omitEnumNames ? '' : 'VIEW_MEDIA');

  /// Allow the user to create media of `PRIVATE` and `LIMITED` visibility. *Not currently enforced.*
  static const Permission CREATE_MEDIA =
      Permission._(41, _omitEnumNames ? '' : 'CREATE_MEDIA');

  /// Allow the user to publish media with `SERVER_PUBLIC` visibility. *Not currently enforced.*
  static const Permission PUBLISH_MEDIA_LOCALLY =
      Permission._(42, _omitEnumNames ? '' : 'PUBLISH_MEDIA_LOCALLY');

  /// Allow the user to publish media with `GLOBAL_PUBLIC` visibility. *Not currently enforced.*
  static const Permission PUBLISH_MEDIA_GLOBALLY =
      Permission._(43, _omitEnumNames ? '' : 'PUBLISH_MEDIA_GLOBALLY');
  ...
  static const Permission BUSINESS =
      Permission._(9998, _omitEnumNames ? '' : 'BUSINESS');
  ...
  static const Permission RUN_BOTS =
      Permission._(9999, _omitEnumNames ? '' : 'RUN_BOTS');
  ...
  static const Permission ADMIN =
      Permission._(10000, _omitEnumNames ? '' : 'ADMIN');
  ...
  static const Permission VIEW_PRIVATE_CONTACT_METHODS =
      Permission._(10001, _omitEnumNames ? '' : 'VIEW_PRIVATE_CONTACT_METHODS');
