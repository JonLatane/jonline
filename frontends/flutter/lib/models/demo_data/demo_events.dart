...
final List<DemoEvent> durhamDemoEvents = [
  DemoEvent(
      ...
      Event()
        ...
        ..occasions.addAll(_generateWeeklyOccasions(
  ...
  DemoEvent(
      ...
      Event()
        ...
        ..occasions.addAll(_generateWeeklyOccasions(
            '2023-04-13 18:00:00-04:00', '2023-04-13 21:00:00-04:00', 30))),
  DemoEvent(
      [DemoGroup.yoga, DemoGroup.fitness, DemoGroup.coolKidsClub],
      Event()
        ..post = (Post()
...
List<Occasion> _generateWeeklyOccasions(
  ...
  for (int i = 0; i < recurringWeeks; i++) {
    occasions.add(_generateOccasion(
...
Occasion _generateOccasion(String startsAtStr, String endsAtStr) {
  DateTime startsAt = DateTime.parse(startsAtStr);
  DateTime endsAt = DateTime.parse(endsAtStr);
  return Occasion()
    ..startsAt = (Timestamp()
