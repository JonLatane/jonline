...
export const CreateAccountRequest: MessageFns<CreateAccountRequest> = {
  encode(message: CreateAccountRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.email !== undefined) {
      ContactMethod.encode(message.email, writer.uint32(26).fork()).join();
    }
    if (message.phone !== undefined) {
      ContactMethod.encode(message.phone, writer.uint32(34).fork()).join();
    }
...
export const CreateThirdPartyRefreshTokenRequest: MessageFns<CreateThirdPartyRefreshTokenRequest> = {
  encode(message: CreateThirdPartyRefreshTokenRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.expiresAt !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CreateThirdPartyRefreshTokenRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const RefreshTokenResponse: MessageFns<RefreshTokenResponse> = {
  encode(message: RefreshTokenResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.refreshToken !== undefined) {
      ExpirableToken.encode(message.refreshToken, writer.uint32(10).fork()).join();
    }
    if (message.accessToken !== undefined) {
      ExpirableToken.encode(message.accessToken, writer.uint32(18).fork()).join();
    }
...
export const ExpirableToken: MessageFns<ExpirableToken> = {
  encode(message: ExpirableToken, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.token !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ExpirableToken {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const AccessTokenRequest: MessageFns<AccessTokenRequest> = {
  encode(message: AccessTokenRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): AccessTokenRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const AccessTokenResponse: MessageFns<AccessTokenResponse> = {
  encode(message: AccessTokenResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.refreshToken !== undefined) {
      ExpirableToken.encode(message.refreshToken, writer.uint32(10).fork()).join();
    }
    if (message.accessToken !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): AccessTokenResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const UserRefreshTokensResponse: MessageFns<UserRefreshTokensResponse> = {
  encode(message: UserRefreshTokensResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.refreshTokens) {
      RefreshTokenMetadata.encode(v!, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): UserRefreshTokensResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const RefreshTokenMetadata: MessageFns<RefreshTokenMetadata> = {
  encode(message: RefreshTokenMetadata, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.id !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): RefreshTokenMetadata {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
