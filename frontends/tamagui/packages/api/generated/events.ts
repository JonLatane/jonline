...
export const GetEventsRequest: MessageFns<GetEventsRequest> = {
  encode(message: GetEventsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.timeFilter !== undefined) {
      TimeFilter.encode(message.timeFilter, writer.uint32(42).fork()).join();
    }
...
export const TimeFilter: MessageFns<TimeFilter> = {
  encode(message: TimeFilter, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.startsAfter !== undefined) {
      Timestamp.encode(toTimestamp(message.startsAfter), writer.uint32(10).fork()).join();
    }
    if (message.endsAfter !== undefined) {
      Timestamp.encode(toTimestamp(message.endsAfter), writer.uint32(18).fork()).join();
    }
    if (message.startsBefore !== undefined) {
      Timestamp.encode(toTimestamp(message.startsBefore), writer.uint32(26).fork()).join();
    }
    if (message.endsBefore !== undefined) {
      Timestamp.encode(toTimestamp(message.endsBefore), writer.uint32(34).fork()).join();
    }
    return writer;
  },
...
export const Event: MessageFns<Event> = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4: {
          ...
          message.instances.push(Occasion.decode(reader, reader.uint32()));
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): Event {
    return {
      ...
      instances: globalThis.Array.isArray(object?.instances)
        ? object.instances.map((e: any) => Occasion.fromJSON(e))
        : [],
    };
  },
  ...
  toJSON(message: Event): unknown {
    ...
    if (message.instances?.length) {
      obj.instances = message.instances.map((e) => Occasion.toJSON(e));
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Event>, I>>(object: I): Event {
    ...
    message.instances = object.instances?.map((e) => Occasion.fromPartial(e)) || [];
    return message;
  },
};
...
export const EventAttendance: MessageFns<EventAttendance> = {
  encode(message: EventAttendance, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.anonymousAttendee !== undefined) {
      AnonymousAttendee.encode(message.anonymousAttendee, writer.uint32(34).fork()).join();
    }
...
export const AnonymousAttendee: MessageFns<AnonymousAttendee> = {
  encode(message: AnonymousAttendee, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.name !== "") {
      writer.uint32(10).string(message.name);
    }
    for (const v of message.contactMethods) {
      ContactMethod.encode(v!, writer.uint32(18).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): AnonymousAttendee {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const UserAttendee: MessageFns<UserAttendee> = {
  encode(message: UserAttendee, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.userId !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): UserAttendee {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
