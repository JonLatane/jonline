...
export const Group: MessageFns<Group> = {
  encode(message: Group, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.avatar !== undefined) {
      MediaReference.encode(message.avatar, writer.uint32(42).fork()).join();
    }
    ...
    if (message.currentUserMembership !== undefined) {
      Membership.encode(message.currentUserMembership, writer.uint32(154).fork()).join();
    }
...
export const GetGroupsRequest: MessageFns<GetGroupsRequest> = {
  encode(message: GetGroupsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetGroupsRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const GetGroupsResponse: MessageFns<GetGroupsResponse> = {
  encode(message: GetGroupsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetGroupsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const GetMembersRequest: MessageFns<GetMembersRequest> = {
  encode(message: GetMembersRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.groupId !== "") {
      writer.uint32(10).string(message.groupId);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetMembersRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const GetMembersResponse: MessageFns<GetMembersResponse> = {
  encode(message: GetMembersResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetMembersResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
