...
export const SingleMediaChooser: React.FC<Props> = ({ selectedMedia, setSelectedMedia, mediaUseName = 'Avatar' }) => {
  ...
  return <YStack key={elementKey} animation='quick' {...standardAnimation}
    ...
    <Button disabled={!selectedMedia} opacity={selectedMedia ? 1 : 0.5}
