...
export function TabsTutorial({ }) {
  ...
  const height = stackGroupsBelow ? '$7' : '$3';
  ...
  return <AnimatePresence>
    {showHelp
      ? <ZStack w='100%' h={height} animation='standard' {...standardAnimation} mt='$2'>
        ...
        <XStack w='100%' ai='center' space='$2' mt={-4}>
          ...
          <XStack f={1} />
          <Paragraph size='$2' textAlign="right">
            {hidingStarted
